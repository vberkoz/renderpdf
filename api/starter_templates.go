...
<style>body{font-family:Arial,sans-serif;color:#172033;margin:48px}header{display:flex;justify-content:space-between;border-bottom:3px solid #2563eb;padding-bottom:20px}h1{margin:0}.meta{text-align:right;color:#526075}.total{margin-top:32px;text-align:right;font-size:22px;font-weight:bold}.label{color:#526075;font-size:12px;text-transform:uppercase;letter-spacing:.08em}</style>
...
<style>body{font-family:Georgia,serif;color:#1f2937;line-height:1.6;margin:54px}h1{text-align:center;text-transform:uppercase;letter-spacing:.08em}section{margin:28px 0}.signature{margin-top:80px;display:flex;justify-content:space-between}.line{border-top:1px solid #374151;padding-top:8px;width:42%}</style>
...
<style>body{font-family:Georgia,serif;text-align:center;color:#312e81;margin:38px;border:12px double #a78bfa;padding:62px}h1{font-size:42px;text-transform:uppercase;letter-spacing:.1em;margin:0}.recipient{font-size:34px;margin:35px 0;color:#111827}.detail{font-size:19px;line-height:1.6}.date{margin-top:40px;font-size:15px;color:#4b5563}</style>
